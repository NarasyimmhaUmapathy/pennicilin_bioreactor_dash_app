...
if __name__ == "__main__":
    ...
    current_timestamp = pd.to_datetime(config['pipeline_runner']['first_timestamp']) #time 0 for batch X
    time_increment = pd.Timedelta(config['pipeline_runner']['time_increment']) #increments by 12 minutes
