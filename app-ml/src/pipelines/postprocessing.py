...
class PostprocessingPipeline:
    ...
    def run_inference(self, y_pred: float, current_timestamp: pd.Timestamp,batch_number:int) -> pd.DataFrame:
        """
        ...
        df_pred = pd.DataFrame({
            'batch_run_datetime': timestamp,
            'pennicilin_predictions': pd.Series(y_pred),
